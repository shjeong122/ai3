...
<html lang="en">
  ...
  <body>
    ...
    <div class="middlebanner">
      <div class="slides">
        <a class="slide" href="소중한 수강평">
          <img src="../wpImages/reviews/review1.png" alt="slide 2" />
        </a>
        <a class="slide" href="소중한 수강평">
          <img src="../wpImages/reviews/review2.png" alt="slide 3" />
        </a>
        <a class="slide" href="소중한 수강평">
          <img src="../wpImages/reviews/review3.png" alt="slide 4" />
        </a>
      </div> 
    </div>-->
...
<div style="text-align:center">
  ...
  <span class="dot"></span> 
    ...
    <main class="bigbg">
      ...
      <div class="bigbanner">
        <a class="corses K" href="korean.html">
          <img src="../wpImages/mainbanners/koreanCorse.jpg" /><span
            class="hovertext"
            >한식과정 자세히보기</span
          >
        </a>
        <a class="corses C" href="chinese.html">
          <img src="../wpImages/mainbanners/chineseCorse.jpg" /><span
            class="hovertext"
            >중식과정 자세히보기</span
          >
        </a>
        <a class="corses J" href="japanese.html">
      ...
      <div class="write">
        <ul class="announcementsbox">
          ...
          <span>공지사항</span>
          <a class="more" href="notice.html">>&nbsp;더보기</a>
          <li><a href="#">2024학년도 하반기 시험 일정</a></li>
          <li><a href="#">수강생 위생 교육 진행 일정</a></li>
          <li><a href="#">한식 조리사 자격증 일정 안내</a></li>
          <li><a href="#">'<'중식 조리사 과정'>' 강의실 안내</a></li>
          <li><a href="#">일식 조리사 자격증 일정 안내</a></li>
        </ul>

        <ul class="suggestionsbox">
          <span class="material-symbols-outlined"> campaign </span>
          <span>건의사항</span>
          <a class="more" href="suggestion.html">>&nbsp;더보기</a>
          <li><a href="#">건의사항 게시판 에티켓을 지켜주세요.</a></li>
          <li><a href="#">온라인 수업 자료는 제공해주실 수 없나요?</a></li>
          <li>
            <a href="#">졸업생 분들과 만나는 자리가 있었으면 좋겠어요.</a>
          </li>
          <li>
            <a href="#">조리사 자격증 시험에 대비하여 특강이 따로 있나요?</a>
          </li>
          <li>
            <a href="#"
              >외부 요리 전문가들도 초청하여 특별 특강을 하면 좋겠어요.</a
            >
          </li>
        </ul>
