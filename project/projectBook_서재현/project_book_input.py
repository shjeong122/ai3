                ...
                if menuSelect == '1' :
                    ...
                    if len(bookList.listName) == 0 :
                        ...
                        if name in bookList.listName and price in bookList.listPrice:    
                            ...
                            project_book_input_def.changeBookInput(i)
                        else : 
                            print('찾기 실패')
                elif menuSelect == '3' :
                    if len(bookList.listName) == 0 :
                        ...
                        if name in bookList.listName and price in bookList.listPrice: 
                            i = bookList.listName.index(name)   
                            project_book_input_def.delete(i)
                        else :
                            print('입력 관련 저장정보가 없습니다.')
                elif menuSelect == '4' :
                    if len(bookList.listName) == 0 :
                        print('저장된 정보가 없습니다.')
                    else :
                        ...
                        price = int(input('가격 : '))
                        if name in bookList.listName and price in bookList.listPrice:    
                            project_book_input_def.listFindSoloBook(name)
                        else :
                            print('입력 관련 저장정보가 없습니다.')
                elif menuSelect == '5' :
                    if len(bookList.listName) == 0 :
                        ...
                        price = int(input('가격 : '))
                        if name in bookList.listName and price in bookList.listPrice:    
                            project_book_input_def.listFindBook(name)
                        else :
                            print('입력 관련 저장정보가 없습니다.')
                elif menuSelect == '6' :
                    if len(bookList.listName) == 0 :
