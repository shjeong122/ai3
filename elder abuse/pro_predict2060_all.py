...
population_65_plus = df.loc['합계'].values.reshape(-1, 1)
...
plt.plot(years, population_65_plus, label="과거 총 인구수", marker='o', color='grey')
plt.plot(2060, predicted_2060, label="2060년도 총 노인수", marker='*', color='red', markersize=12 )
plt.xlabel('연도', size=15)
plt.ylabel('총 인구수', size=15)
plt.title('2060년 총 인구 수 예측', size=25)
plt.legend()
plt.show()